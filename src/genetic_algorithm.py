...
class GeneticAlgorithm:
    ...
    def _batch_fitness(self, individuals):
        """Compute discrimination scores for multiple individuals at once."""
        if not individuals:
            return []
    ...
    def run(self, n_evals=None, return_details=False):
        ...
        pop_fitness = self._batch_fitness(population)
        ...
        while eval_count < max_evals:
            ...
            offspring_fitness = self._batch_fitness(offspring)
            ...
            if offspring_fitness:
                ...
                mean_curve.append(float(np.mean(new_fitness)))
